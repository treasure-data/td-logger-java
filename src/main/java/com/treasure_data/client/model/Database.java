...
//    }
    ...
    public boolean createLogTable(String tableName) throws IOException, ClientException {
        return getClient().createLogTable(name, tableName);
    }

    public boolean createItemTable(String tableName) throws IOException, ClientException {
        return getClient().createItemTable(name, tableName);
    }

    public boolean delete() throws IOException, ClientException {
        return getClient().deleteDatabase(name);
    }
